...
namespace AspApp_VenteVetements.Controllers
{
    public class UtilisateursController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nom,statutId,adresseMail,motDePasse")] Utilisateur utilisateur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nom,statutId,adresseMail,motDePasse")] Utilisateur utilisateur)
        {
            if (ModelState.IsValid)
            {
